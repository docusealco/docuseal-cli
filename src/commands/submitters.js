...
export function registerSubmitterCommands(program) {
  ...
  withGlobalOptions(topic.command('list'))
    ...
    .addOption(new Option('--external-id <value>', 'The unique application-specific identifier provided for a submitter when initializing a signature request. It allows you to receive only submitters with a specified external ID.'))
